...
public class LecturersPanel extends JPanel {
    ...
    public LecturersPanel() {
        ...
        JLabel lbl = new JLabel("Lecturers Management", JLabel.CENTER);
        ...
        Object[][] data = {
                {"L001", "Dr. Kumar Sanga", "kumar@example.com", "Software Engineering"},
                {"L002", "Prof. Jane Doe", "jane@example.com", "Computer Science"}
        };
